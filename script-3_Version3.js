            ...
            track.events.forEach(event => {
                ...
                if (event.type === 'noteOn') {
                    ...
                    if (noteOn) {
                        ...
                        // Применяем огибающую
                        if (this.waveType === 'piano' || this.waveType === 'guitar') {
                            noteGain.gain.exponentialRampToValueAtTime(0.01, noteOn.startTime + Math.min(noteDuration, 2));
                        } else if (this.waveType === 'strings' || this.waveType === 'brass') {
                            noteGain.gain.linearRampToValueAtTime(volumeMultiplier, noteOn.startTime + 0.1);
